...
OPENAI_MEAL_MODEL = os.environ.get("OPENAI_MEAL_MODEL", OPENAI_DEFAULT_MODEL)
OPENAI_REPORT_MODEL = os.environ.get("OPENAI_REPORT_MODEL", OPENAI_DEFAULT_MODEL)

MAX_UPLOAD_BYTES = 10 * 1024 * 1024
MEAL_PHOTO_TARGET_BYTES = env_int("IBS_FIGHTER_MEAL_PHOTO_TARGET_KB", 500) * 1024
MEAL_PHOTO_MAX_DIMENSION = env_int("IBS_FIGHTER_MEAL_PHOTO_MAX_DIMENSION", 2000)
IMAGE_EXTENSIONS = {
    "image/jpeg": ".jpg",
    "image/png": ".png",
    "image/webp": ".webp",
